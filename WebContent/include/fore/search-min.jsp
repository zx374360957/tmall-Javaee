...
<div class="g-search-mid">
	<a class="u-search-mlogo" href="foreindex"><img src="/tmall/image/site/simpleLogo.png" alt="tmall天猫" /></a>
	<div>
		<div class="m-search-min">
			<form action="foresearch" method="post">
				<input class="u-search-input-min" id="name" name="name" type="text" placeholder="风冷无霜 大容量更优惠" />
