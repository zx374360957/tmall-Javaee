...
<c:forEach items="${o.orderItems}" var="oi">
	...
	<div class="item-info">
		...
		<div><span class="head">价格:</span> <strong class="s-redColor" style="font-size: 18px;">￥<strong>￥<fmt:formatNumber value="${oi.product.promotePrice * oi.number}" pattern="#,#00.00#" /> </strong>元</div>
		<div><span class="head">配送:</span> 快递: 0.00</div>
		<div><span class="head">月销量:</span> <strong class="s-redColor">50</strong>件</div>
	</div>
